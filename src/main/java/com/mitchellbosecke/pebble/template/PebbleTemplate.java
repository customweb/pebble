 ...
 * {@link com.mitchellbosecke.pebble.PebbleEngine}. A template by itself is
 * stateless and can therefore be re-used over and over to provide different
 * outputs depending on the variables that are provided at the time of
 * evaluation.
 */
public interface PebbleTemplate {

	/**
	 * Evaluate the template without any provided variables. This will use the
	 * default locale provided by the
	 * {@link com.mitchellbosecke.pebble.PebbleEngine}.
	 *
	 * @param writer
	 *            The results of the evaluation are written to this writer.
	 * @throws PebbleException
	 *             An exception with the evaluation of the template
	 * @throws IOException
	...
	/**
	 * Evaluate the template with a particular locale but without any provided
	 * variables.
	 *
	 * @param writer
	 *            The results of the evaluation are written to this writer.
	...
	/**
	 * Evaluate the template with a set of variables and the default locale
	...
	/**
	 * The object printer to use to print objects within this template.
	 *
	 * @return the printer which should be used to print object.
	 */
	ObjectPrinter getObjectPrinter();
