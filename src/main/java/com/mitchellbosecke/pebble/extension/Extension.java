...
public interface Extension {
	...
	/**
	 * An object printer can be used to convert an object into a string before
	 * it is printed to the output stream. When for an object no object printer
	 * is injected we will call the {@link Object#toString()} method.
	 *
	 * @return a list of {@link ObjectPrintStrategy}.
	 */
	List<ObjectPrintStrategy> getObjectPrintStrategies();
}
